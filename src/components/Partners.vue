        ...
        <div id="partners-container">
            <div class="partners-title-wrapper">
                <div class="container custom-container">
                    <h2 class="heading heading-main">{{$t('My Projects')}}<span class="orange-color">:</span></h2>
                </div>
            </div>
            <div class="d-none d-lg-block" id="partners-slider-container">
                <div class="partners-progress-container">
                    <div id="partners-slider">
                        <div class="partner" v-for="(partner, index) in newArrayProjects" :key="index"
                             :id="'partner' + (index + 1)">
                    ...
                    <div class="position-relative timeline-progressbar-container">
                        <div class="d-flex justify-content-around">
                            <div class="progress-name"
                                 v-for="(partner, index) in newArrayProjects"
                                 :key="index"
  ...
  export default {
    ...
    data() {
      return {
        ...
        newArrayProjects : [
          {imageUrl : 'src/assets/img/crm.gif' ,name :'CRM for Small Business',description : '',occupation:'Online Client Relation Manager '},
          {imageUrl : 'src/assets/img/einv.gif' ,name :'E-invoicing Web Apps',description : 'Online progressive web app to avoid papers and to minimize headaches',occupation:''},
          {imageUrl : 'src/assets/img/ocr.gif' ,name :'AI module to read Invoices',description : '',occupation:''},
          {imageUrl : 'src/assets/img/AB.gif' ,name :'Vue.js showcase website',description : '',occupation:''},
          {imageUrl : '' ,name :'AI chatbot for ESPRIT university',description : '',occupation:''},
            {imageUrl : 'src/assets/img/PM.gif' ,name :' Showcase Website',description : ' <router-link class="strike"\n' +
                  '                                             :to="lang === \'en\' ? \'/en/bio\' : \'/bio\'"\n' +
                  '                                             :title="$t(\'allAchievements\')">\n' +
                  '                                    <span>{{$t(\'here 👆\')}}.</span>\n' +
                  '                                </router-link>',occupation:''},
